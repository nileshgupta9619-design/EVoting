            ...
            <div className="relative w-full max-w-md">
                <div className="bg-slate-800/90 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-purple-500/20">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-purple-300 text-sm">Sign in to access your dashboard</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full mt-2 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold shadow-lg shadow-purple-500/30 transition disabled:opacity-60"
                        >
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm">
                        <button
                            ...
                            className="text-purple-300 hover:text-purple-100 font-medium text-left"
                        >
                            Forgot Password?
                        </button>
                        <p className="text-slate-300 mt-2 sm:mt-0">
